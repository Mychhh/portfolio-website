...
const Landingpage3 = () => {
    return ( 
        <>
            <div className="dark:bg-[#272829] p-10 ">
                <div className="w-10/12 mx-auto flex flex-col md:flex-row gap-0 md:gap-10">
                    ...
                    <div className="order-2 md:order-none flex items-center justify-center pt-10 w-full md:w-6/12">
                        <div className="flex flex-col gap-5 w-10/12 md:w-9/12">
                            <p>if you want to know me more just click the button bellow to view all my contacts or just leave me a message here</p>
                            <Link to="/ContactPage">
